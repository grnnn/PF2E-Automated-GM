"use strict";
const genClientBase = (className, { hasSheet = true, isCanvasDoc = false, parents = isCanvasDoc ? [{ name: "Scene", hasParents: false }] : [], }) => {
...
// imports
console.log(String.raw `import type { ApplicationV2, DocumentSheetV2 } from "../../../client-esm/applications/api/module.d.ts";

`);
for (const [className, data] of Object.entries(clientDocs)) {
    genClientBase(className, data);
}
//# sourceMappingURL=generate-client-base-mixes.js.map